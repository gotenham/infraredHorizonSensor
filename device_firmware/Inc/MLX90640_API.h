 ...
 *
 */
#ifndef INC_MLX90640_API_H_
#define INC_MLX90640_API_H_
	...
	// AJ: Added custom enum class to track progress of image construction from subpages 1 & 2
    enum class MLXFrameProgress : int {
        IMG_REQUESTED = 0,
        IMG_READY = 1,
		PROGRESS_SUBPAGE1 = 2
		//,PROGRESS_SUBPAGE2 = 3
